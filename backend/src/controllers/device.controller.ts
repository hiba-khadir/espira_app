...
// GET /api/devices/:id
const getDeviceByIdController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
// POST /api/devices
const createDeviceController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
    ...
    if (!name || !subtypeId || !stateTopic) {
      res
        .status(400)
        .json({ message: "name, subtypeId and stateTopic are required" });
      return;
    }
    ...
    if (!device) {
      res.status(400).json({ message: "Invalid subtypeId" });
      return;
    }
...
// PUT /api/devices/:id
const updateDeviceController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
const getDeviceStateController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
const updateDeviceStateController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  //params
...
const getDeviceHistoryController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
const getDeviceSubtypeController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
