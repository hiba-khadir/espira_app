...
export default function HomeAssistantScreen() {
  ...
  const openDashboard = () => {
    Linking.openURL("http://homeassistant.local:8123").catch(() => {
      alert(
        "Couldn't open dashboard URL. Make sure you have a browser installed or the URL is correct.",
      );
    });
  };
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FAFAFA]">
      <View className="flex-row items-center px-6 pt-4 mb-8">
        ...
        <Text className="text-2xl font-bold text-[#065A2C] ml-6">
          Home Assistant
        </Text>
      </View>
      ...
      <View className="flex-1 items-center justify-center px-6 pb-20">
        ...
        <Text className="text-xl text-center text-gray-700 mb-8 font-medium">
          Connect and manage your smart home devices through the Home Assistant
          dashboard.
        </Text>
        <TouchableOpacity
