...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FAFAFA]">
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} className="px-6 pt-8">
        {/* Header */}
        ...
        {/* Account Setting */}
        <Text className="text-xl font-bold text-[#065A2C] mb-4">Account Setting</Text>
        <View className="space-y-3 mb-8">
          ...
          >
            <View className="flex-row items-center">
              ...
              <Text className="text-base text-[#065A2C] font-semibold ml-3">Edit profile</Text>
            </View>
          ...
          >
            <View className="flex-row items-center">
              ...
              <Text className="text-base text-[#065A2C] font-semibold ml-3">Home assistant</Text>
            </View>
            <Feather name="chevron-right" size={20} color="#333" />
          </TouchableOpacity>
        </View>
        ...
        <View className="space-y-3 mb-10">
          ...
          >
            <View className="flex-row items-center">
              <Ionicons name="document-text-outline" size={20} color="#065A2C" />
              <Text className="text-base text-[#065A2C] font-semibold ml-3">Terms and Condition</Text>
            </View>
          ...
          >
            <View className="flex-row items-center">
              <Ionicons name="shield-checkmark-outline" size={20} color="#065A2C" />
              <Text className="text-base text-[#065A2C] font-semibold ml-3">Privacy policy</Text>
            </View>
            <Feather name="external-link" size={18} color="#333" />
          </TouchableOpacity>
          ...
          >
            <View className="flex-row items-center">
              ...
              <Text className="text-base text-[#065A2C] font-semibold ml-3">Help</Text>
            </View>
            <Feather name="external-link" size={18} color="#333" />
          </TouchableOpacity>
        </View>
